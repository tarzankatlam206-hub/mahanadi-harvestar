...
export default function App(){
  ...
  return(
    <SafeAreaView style={s.safe}>
      ...
      {view==='logout' && <View style={{flex:1,justifyContent:'center',alignItems:'center',paddingBottom:60}}><View style={[s.card,{width:'92%',alignItems:'center',padding:25}]}><Text style={{fontSize:22,fontWeight:'bold'}}>लॉग आउट करें?</Text><Text style={{color:'#666',marginTop:8,textAlign:'center',fontSize:14}}>डाटा डिलीट नहीं होगा</Text><TouchableOpacity style={[s.mBtn,{backgroundColor:'#212121',width:'100%',marginTop:25,paddingVertical:18}]} onPress={doLogout}><Text style={[s.mBtnT,{fontSize:18}]}>हाँ, लॉग आउट</Text></TouchableOpacity><TouchableOpacity style={[s.mBtn,{backgroundColor:'#4CAF50',width:'100%',marginTop:15,paddingVertical:18}]} onPress={()=>setView('home')}><Text style={[s.mBtnT,{fontSize:18}]}>नहीं</Text></TouchableOpacity></View></View>}
